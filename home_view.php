...
<html lang="es">
  ...
  <body>
    <nav class="navbar navbar-feisbuc d-flex justify-content-between align-items-center">
      <div class="grid_nav_1 links_home ml-3">
        <a href="#" class="link-feisbuc">Inicio</a>
        <a href="#" class="link-feisbuc">Notificaciones</a>
        <a href="#" class="link-feisbuc">Mensajes</a>
      </div>
